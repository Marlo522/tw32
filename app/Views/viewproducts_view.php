            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="text-center">
                        <label class="form-label small fw-semibold d-flex align-items-center justify-content-center gap-1 mb-3 text-light">
                            <span class="material-symbols-outlined text-light" style="font-size:18px;">image</span>Product Image
                        </label>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            <label class="form-label small fw-semibold d-flex align-items-center gap-1 text-light">
                                <span class="material-symbols-outlined text-light" style="font-size:18px;" >label</span>Product Name
                            </label>
